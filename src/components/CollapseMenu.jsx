      ...
      <div
        ...
        className={`${
          pathname.includes(path)
            ...
            : " text-gray-900"
        } text-gray-900 border focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center gap-x-2 cursor-pointer
